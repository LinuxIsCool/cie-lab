// P9 · Multi-tenant SaaS shell — the productization one-way door. Not a full SaaS;
// its job is to surface what tenancy demands of the data contract before those
// assumptions bake in. A console of isolated instances + the contract implications.
    ...
    <div className="max-w-5xl">
      <header className="mb-4">
        <div className="flex items-center gap-2">
          <h1 className="text-xl font-bold tracking-tight">Multi-tenant SaaS shell</h1>
          <span className="text-[11px] font-semibold px-2 py-0.5 rounded bg-slate-800 text-white">P9 · POC #10</span>
        </div>
      ...
      <div className="mb-5 space-y-2">
        <Commentary kind="perspective" title="What a platform adds">
          Running one campaign is a project; hosting many campaigns on shared infrastructure is a product. This console shows several instances side by side, each sealed off from the others — the shape a productized CIE would take.
        </Commentary>
      ...
      <div className="mt-5 space-y-2">
        <Commentary kind="architecture" title="Built on our own core">
          Because CIE runs its own engine rather than a fork of someone else's, it can be offered as a hosted product at all — the licensing dead-end that ruled out copying another platform (see P1) is exactly what this depends on.
        </Commentary>
        <Commentary kind="goal" title="The real question this forces">
          The demands above are the price of scale. Whether CIE ever becomes a product, or stays a single-campaign recipe run fresh each time, is the choice this shell puts in front of you — and it's worth making deliberately, since the data model follows from it.
        </Commentary>
      </div>

      <footer className="mt-8 text-center text-[11px] text-slate-400">
        A shell, not a live SaaS — its value is making tenancy's demands on the contract visible before they're committed to.
      </footer>
    </div>
  );
}
