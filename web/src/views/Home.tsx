    ...
    <div className="max-w-4xl">
      <header className="mb-4">
        <div className="flex items-center gap-2">
          <h1 className="text-xl font-bold tracking-tight">Civic Intelligence Engine Lab: Prototype Portfolio</h1>
          <span className="text-[11px] font-semibold px-2 py-0.5 rounded bg-slate-800 text-white">reserved · local-first</span>
        </div>
        <p className="text-sm text-slate-500 mt-1 max-w-2xl">
          The Civic Intelligence Engine is a tool for helping a community be heard, and helping
      ...
      <DesignNotes title="New here? Start with this">
        <Commentary kind="perspective" title="What this project is">
          ...
          residents. A normal survey just counts heads and reports what the biggest group wants. The Civic Intelligence Engine is built to
        ...
        <Commentary kind="principle" title="Why you can trust the numbers">
          The single rule everything obeys: every number you see comes from people's actual votes. The artificial intelligence never
          decides what's popular, it only does the wordsmithing (naming the groups, paraphrasing comments,
          answering questions in plain English), and always points back to the votes. Take the artificial intelligence away and the
        ...
        <Commentary kind="architecture" title="Free, local, and private">
          Everything here runs on free artificial intelligence models on this one machine ($0), using made-up sample data. No real
